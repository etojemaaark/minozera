...
ymaps.ready(function () {
	...
	threeCollection.add(myPlacemark5).add(myPlacemark6);
	// fourCollection.add(myPlacemark7).add(myPlacemark8);
	fiveCollection.add(myPlacemark9).add(myPlacemark10).add(myPlacemark11);
	// sixCollection.add(myPlacemark12).add(myPlacemark13).add(myPlacemark14);
